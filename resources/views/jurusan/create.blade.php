                    ...
                    <div class="card-body">
                        <form action="{{ route('jurusan.store') }}" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea type="text"name="nama_mata_pelajaran" class="form-control @error('nama_mata_pelajaran') is-invalid @enderror"></textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea type="text"name="jurusan2" class="form-control @error('jurusan2') is-invalid @enderror"></textarea>
                                @error('jurusan2')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
